...
void main() {
  group('Non-Concordia Building Route Preview Feature', () {
    ...
    test(
      'Route origin text uses "Current location" for non-Concordia places',
      () {
    ...
    test(
      'Searching for multiple non-Concordia places shows route preview for each',
      () {
        final places = [
          SearchResult(
            name: 'Restaurant A',
    ...
    test(
      'Non-Concordia place can have null placeId for some search results',
      () {
    ...
    test(
      'Route preview mode differentiates Concordia and non-Concordia places',
      () {
        ...
        expect(
          concordia.isConcordiaBuilding != nonConcordia.isConcordiaBuilding,
          isTrue,
        );
      },
    );
