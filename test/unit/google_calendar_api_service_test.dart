...
void main() {
  group('GoogleCalendarApiService', () {
    ...
    test('fetchCalendars returns empty list when response items are null', () async {
      final response = gcal.CalendarList();
    ...
    test('fetchUpcomingEvents maps events correctly', () async {
      ...
      expect(
        ...
        isA<GoogleCalendarEvent>()
            ...
            .having((e) => e.location, 'location', 'H-937')
    ...
    test('fetchUpcomingEvents filters out events with empty ids', () async {
      final validEvent = gcal.Event()
        ...
        ..summary = 'Valid event'
        ..start = (gcal.EventDateTime()
          ..dateTime = DateTime(2026, 3, 12, 10))
        ..end = (gcal.EventDateTime()
          ..dateTime = DateTime(2026, 3, 12, 11));

      final invalidEvent = gcal.Event()
        ..id = ''
        ..summary = 'Invalid event'
        ..start = (gcal.EventDateTime()
          ..dateTime = DateTime(2026, 3, 12, 12))
        ..end = (gcal.EventDateTime()
          ..dateTime = DateTime(2026, 3, 12, 13));
    ...
    test('fetchUpcomingEvents returns empty list when response items are null', () async {
